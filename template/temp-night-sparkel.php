...
<head>
  ...
  <link rel="stylesheet" href="../assets/css/theme/theme4.css" />
</head>
...
<body>
  ...
  <header id="home" class="page-scroll">
    ...
    <div class="text">
      ...
      <h1><?= $result_pengantin->nama_pria ?> & <?= $result_pengantin->nama_wanita ?></h2>
        <?php $s = strtotime("$result_detail->waktu_resepsi $result_detail->tgl_resepsi"); ?>
        <div class="tgl"><?= date('d F Y', $s) ?></div>
        <div class="header-row">
          <h3>
    ...
    <div class="boxContainer">
      <div class="box" data-aos="fade-right">
        <div class="img" style="background-image: url(../assets/img/order/<?= $result_pengantin->img_pria ?>)">
          <img src="../assets/img/theme/theme4/variasi.png" class="pria" alt="" />
        </div>
  ...
  <section class="layout acara page-scroll" id="acara">
    <div class="heading" data-aos="fade-up">Jadwal Acara</div>
    <img src="../assets/img/theme/theme4/variasi3.png" class="variasi2" alt="" />
    <div class="boxContainer">
      <div class="box" data-aos="fade-right">
  ...
  <div class="layout story page-scroll" id="story">
    ...
    <div class="box" id="slide1" data-aos="fade-up">
      ...
      <div class="image">
        <img src="../assets/img/theme/theme4/variasi-image.png" class="variasi-image" />
  ...
  <section class="quete layout" id="quete">
    <div class="boxContainer">
      ...
      <img src="../assets/img/theme/theme4/variasi4.png" class="variasi1" alt="" />
      <img src="../assets/img/theme/theme4/variasi5.png" class="variasi2" alt="" />
    </div>
  </section>
  <!-- end Quete -->
  ...
  <!-- <iframe
      ...
      width="50"
      height="50"
      src="https://www.youtube.com/embed/YsC-2-cdLPw?enablejsapi=1&version=3&playerapiid=ytplayer&autoplay=1"
      modestbranding="0"
      controls="0"
      frameborder="0"
