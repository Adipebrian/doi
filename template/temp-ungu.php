...
<head>
  ...
  <link rel="stylesheet" href="../../../../assets/css/theme/theme2.css" />
</head>
...
<body>
    ...
    <div class="cover-container">
      <div class="cover-content" style="background-image: url(/../../assets/img/order/<?= $result_pengantin->img_berdua ?>)">
        <div class="box">
          ...
          <h2><?= $result_pengantin->nama_pria ?> & <?= $result_pengantin->nama_wanita ?></h2>
          <?php $s = strtotime("$result_detail->waktu_resepsi $result_detail->tgl_resepsi"); ?>
          <div class="gradient tgl"><?= date('d F Y', $s) ?></div>
          <div class="gradient btn_open close-cover">
            <i class="icon_open"></i>
            Open
          </div>
        </div>
  ...
  <!-- pengantin -->
  <section class="gradient pengantin page-scroll" id="pengantin">
    <div class="heading" data-aos="fade-up">Pengantin Pria dan Wanita</div>
    <div class="boxContainer">
      <div class="box" data-aos="fade-right">
        <div class="img" style="background-image: url(../../../../assets/img/order/<?= $result_pengantin->img_pria ?>)"></div>
      ...
      <div class="box" data-aos="fade-left">
        <div class="img" style="background-image: url(../../../../assets/img/order/<?= $result_pengantin->img_wanita ?>)"></div>
  ...
  <!-- Acara -->
  <section class="gradient acara layout page-scroll" id="acara">
    <div class="heading" data-aos="fade-up">Acara</div>
    <div class="boxContainer">
      <div class="box" data-aos="fade-right">
        ...
        <a target="_blank" href="<?= $result_detail->maps_akad ?>" class="btn_maps gradient">
          <i class="icon_maps"></i>
          Maps
        </a>
      </div>
      <div class="box" data-aos="fade-left">
        ...
        <a target="_blank" href="<?= $result_detail->maps_resepsi ?>" class="btn_maps gradient">
          <i class="icon_maps"></i>
          Maps
        </a>
      </div>
  ...
  <!-- Countdown -->
  <section class="layout ct gradient page-scroll" id="ct">
    <div class="heading" data-aos="fade-up">Countdown</div>
    <div class="boxContainer">
      <div class="box" data-aos="fade-right">
        <h3 id="hari"></h3>
        <p>Hari</p>
    ...
    <div class="gradient ct-stop" id="stop" data-aos="fade-up"></div>
  </section>
  <!-- End Countdown -->

  <!-- galery -->
  <section class="layout gradient galery page-scroll" id="galery">
    <div class="heading" data-aos="fade-up">Galery</div>
    <div class="boxContainer">
  ...
  <?php if ($result->paket_id > 1) : ?>
    <section class="layout gradient video" id="video">
  ...
  <!-- Streaming -->
  <?php if ($result->paket_id > 1) : ?>
    <section class="layout gradient live" id="live">
  ...
  <?php if ($result->paket_id == 3) : ?>
    <section class="layout gradient 3droom" id="3droom">
  ...
  <!-- kisah cinta -->
  <div class="layout gradient story page-scroll" id="story">
    <div class="heading" data-aos="fade-up">Kisah Cinta</div>
  ...
  <!-- Quete -->
  <section class="quete layout gradient" id="quete">
    <p data-aos="flip-up">
  ...
  <!-- buku tamu -->
  <section class="tamu layout gradient page-scroll" id="tamu">
    <div class="heading" data-aos="fade-up">Buku Tamu</div>
    <?php if ($tamu) : ?>
      <form action="/ucapan/store" method="POST" data-aos="fade-up">
        ...
        <button type="submit" class="btn_send gradient">
          <i class="icon_send"></i>
          Kirim
        </button>
      </form>
  ...
  <!-- tamu -->
  <section class="tamu layout gradient" id="tamu">
  ...
  <!-- mengundang -->
  <section class="mengundang layout gradient" id="mengundang">
    <div class="heading" data-aos="fade-up">Turut Mengundang</div>
  ...
  <?php if ($result->paket_id > 1) : ?>
    <div class="up-fixed" id="gift">
      <div class="btn_gift gradient open">
        <i class="icon_gift"></i>
        Gift
      </div>
    </div>
    ...
    <div class="modal hide">
      <div class="modal-container gradient hide">
        <div class="heading" data-aos="fade-up">Gift</div>
        ...
        <div class="heading" data-aos="fade-up">Terimakasih</div>
      </div>
    </div>
  <?php endif; ?>
  <!-- sticky -->
  <a class="play-video" id="button">
    <img src="../../../../assets/img/theme/play.png" alt="" />
  </a>
  <a class="pause-video" id="button2">
